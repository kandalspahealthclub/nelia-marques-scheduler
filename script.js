    ...
    contentArea.innerHTML = `
        <div class="dashboard-grid stats-grid">
            ...
            <div class="card stat-card" style="border-color: var(--rose);">
                ...
                <div class="stat-info">
                    <span class="label">Aniversários</span>
                    <div style="max-height: 40px; overflow-y: auto; font-size: 0.8rem; font-weight: 600; line-height: 1.2;">
                        ${bdays.length > 0 ? bdays.map(b => `<div style="margin-bottom:2px;">${b.name.split(' ')[0]} (${b.dayDisplay})</div>`).join('') : '<span class="value" style="font-size: 1.5rem;">0</span>'}
                    </div>
                </div>
            </div>
        </div>
